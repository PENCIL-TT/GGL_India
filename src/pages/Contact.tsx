...
const defaultContent: ContactContent = {
  hero: { heading: "Get in Touch", subheading: "We're here to help and answer any questions you might have." },
  formHeading: "Send us a Message",
  formSubtext: "Fill in the form below and we'll get back to you as soon as possible.",
};

const Contact = () => {
  const { content } = useContent("contact", defaultContent);
    ...
    <div className="min-h-screen flex flex-col relative">
      ...
      <main className="flex-grow">
        ...
        >
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-5">{content.hero.heading}</h1>
        ...
        <section className="py-16 bg-gray-50 relative">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-2xl font-bold mb-4">{content.formHeading}</h2>
