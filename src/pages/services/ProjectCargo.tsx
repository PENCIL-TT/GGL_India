...
const ProjectCargo = () => {
  const { service } = useService('project-cargo');
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/2">
                ...
                duration: 0.5
                  ...
                  {service?.title || 'Project Cargo Services'}
                </motion.h1>
                <motion.p initial={{
                opacity: 0,
                y: 20
              ...
              <div className="md:w-1/2">
                ...
                duration: 0.5
                  ...
                  <img alt="Project Cargo Service" className="w-full h-auto object-cover" src={service?.heroImage || "/lovable-uploads/2efada81-c85e-4f6b-951a-1b2be0f38a3d.png"} />
                </motion.div>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto mb-16">
              ...
              <div className="space-y-6">
                {(service?.handlingSteps && service.handlingSteps.length > 0
                  ? service.handlingSteps.map((step) => ({ icon: <Route className="h-6 w-6" />, title: step.title, description: step.description }))
                  : [{
            ...
            <div className="max-w-4xl mx-auto mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {(service?.whyChooseUs && service.whyChooseUs.length > 0
                  ? service.whyChooseUs.map((point) => ({ icon: <CheckCircle className="h-6 w-6" />, title: point, description: '' }))
                  : [{
