...
const CustomsClearance = () => {
  const { service } = useService('customs-clearance');
  return (
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/2">
                ...
                >
                  {service?.title || 'Customs Clearance Services'}
                </motion.h1>
                <motion.p 
                  initial={{ opacity: 0, y: 20 }} 
                  animate={{ opacity: 1, y: 0 }} 
                ...
                >
                  {service?.subtitle || 'Expert solutions for seamless border crossings'}
                </motion.p>
                <motion.div 
                  initial={{ opacity: 0, y: 20 }} 
                  animate={{ opacity: 1, y: 0 }} 
              ...
              <div className="md:w-1/2">
                ...
                >
                  <img 
                    src={service?.heroImage || "/lovable-uploads/cc.jpg"} 
