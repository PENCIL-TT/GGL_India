...
const Transportation = () => {
  const { service } = useService('transportation');
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/2">
                ...
                duration: 0.5
                  ...
                  {service?.title || 'Transportation & Distribution'}
                </motion.h1>
                <motion.p initial={{
                opacity: 0,
                y: 20
                ...
                delay: 0.1
                  ...
                  {service?.subtitle || 'Reliable domestic and international transportation services'}
                </motion.p>
                <motion.div initial={{
                opacity: 0,
                y: 20
              ...
              <div className="md:w-1/2">
                ...
                duration: 0.5
                  ...
                  <AspectRatio ratio={16 / 9}>
                    <img alt="Transportation Service" className="w-full h-full object-cover" src={service?.heroImage || "/lovable-uploads/4691638c-d519-46a4-9e19-05fc2c9ed326.png"} />
                  </AspectRatio>
                </motion.div>
              </div>
            </div>
