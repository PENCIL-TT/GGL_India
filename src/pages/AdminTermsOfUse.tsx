...
const AdminTermsOfUse: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch('/api/content/terms-of-use', {
        method: 'PUT',
        headers: { 
      ...
      setStatusMsg({ type: 'success', text: 'Terms of Use saved successfully!' });
  ...
  return (
    <AdminLayout>
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Edit Terms of Use</h1>
            <p className="text-gray-500 mt-1">Manage sections and subsections displayed on the public Terms page.</p>
          </div>
              ...
              <div className="flex justify-between items-start mb-4 gap-4">
                <div className="flex-grow space-y-4">
                  <div>
                    ...
                    <Input value={section.title} onChange={(e) => updateSection(secIndex, 'title', e.target.value)} placeholder="e.g. Acceptance of Terms" className="font-semibold text-lg bg-gray-50" />
                  </div>
                  <div>
